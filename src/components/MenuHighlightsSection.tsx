...
export const MenuHighlightsSection: React.FC<MenuHighlightsSectionProps> = ({ onSelectMenuItem }) => {
  ...
  const categories = [
    ...
    { id: 'salgados', label: '🥐 Salgados Assados' },
    ...
    <section id="cardapio" className="py-16 sm:py-24 bg-[#FAF7F2]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {categories.map((cat) => {
            ...
            return (
              <motion.button
                ...
                className={`relative px-4 sm:px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-semibold transition-colors duration-200 cursor-pointer ${
                  isActive
                    ? 'text-white'
              ...
              >
                ...
                <div className="px-6 pb-6 pt-2 flex items-center justify-between gap-3 border-t border-[#F0E6D8]">
                  ...
                  <motion.button
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-[#F0E6D8] text-[#8C5E44] hover:bg-[#8C5E44] hover:text-white transition-all cursor-pointer"
                  >
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: '-50px' }}
          transition={{ duration: 0.5 }}
          className="mt-14 bg-gradient-to-r from-[#4A3728] via-[#5C4635] to-[#4A3728] rounded-3xl p-8 sm:p-10 text-[#FAF7F2] relative overflow-hidden shadow-xl border border-[#D9C5B2]/40 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6"
        >
          ...
          <motion.a
            ...
            className="shrink-0 inline-flex items-center gap-2 px-6 py-4 rounded-2xl text-sm font-bold bg-[#8C5E44] text-[#FAF7F2] hover:bg-[#704832] transition-all shadow-lg cursor-pointer"
          >
