...
import { LANDING_PAGE_COPY_SECTIONS, FRAMER_COLOR_PALETTE, CLIENT_DATA } from '../data/copyData';
import { SectionCopy } from '../types';
import { X, Copy, Check, Sparkles, Download, Layers, Palette, Type, ShieldCheck, FileText } from 'lucide-react';
...
`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-[#FAF7F2] w-full max-w-5xl max-h-[90vh] rounded-3xl border-2 border-[#8C5E44] shadow-2xl flex flex-col overflow-hidden">
