...
export const LocationHoursSection: React.FC<LocationHoursSectionProps> = ({ onOpenWhatsAppModal }) => {
  return (
    <section id="localizacao" className="py-16 sm:py-24 bg-[#FAF7F2] border-t border-[#D9C5B2]">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="bg-white p-5 rounded-2xl border border-[#D9C5B2] flex items-start gap-4 shadow-xs">
                ...
                <div>
                  <h3 className="font-bold text-sm text-[#4A3728]">Endereço Completo</h3>
                  <p className="text-xs text-[#6B5E55] mt-1 font-medium">{CLIENT_DATA.location}</p>
                  <p className="text-[11px] text-[#8C5E44] mt-0.5 font-semibold">Ponto de referência: Próximo ao Centro Comercial</p>
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-[#D9C5B2] flex items-start gap-4 shadow-xs">
                ...
                <div>
                  <h3 className="font-bold text-sm text-[#4A3728]">Horário de Funcionamento</h3>
                  <p className="text-xs text-[#4A3728] mt-1 font-semibold">{CLIENT_DATA.hours}</p>
                  <p className="text-[11px] text-[#6B5E55] mt-0.5">Atendimento presencial e retiradas no balcão</p>
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-[#D9C5B2] flex items-start gap-4 shadow-xs">
                ...
                <div>
                  <h3 className="font-bold text-sm text-[#4A3728]">Contato & WhatsApp</h3>
                  <p className="text-xs text-[#4A3728] mt-1 font-bold">{CLIENT_DATA.whatsapp}</p>
                  <p className="text-[11px] text-[#6B5E55] mt-0.5">Tire dúvidas, peça encomendas ou reserve mesa</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-3 rounded-3xl border border-[#D9C5B2] shadow-xl relative overflow-hidden">
              ...
              {/* Map Badge */}
              <div className="absolute top-6 left-6 z-10 bg-[#FDFBF7]/95 backdrop-blur-md px-4 py-2 rounded-2xl shadow-md border border-[#D9C5B2] flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-[#8C5E44] animate-pulse" />
                <span className="text-xs font-bold text-[#4A3728]">Divino Sabor - Capão Bonito - SP</span>
              </div>

              {/* Embedded Google Maps Frame */}
              <div className="w-full h-[380px] sm:h-[440px] rounded-2xl overflow-hidden bg-[#FAF7F2] relative">
                <iframe
              ...
              <div className="p-4 bg-[#FAF7F2] rounded-xl mt-3 flex items-center justify-between flex-wrap gap-2 text-xs text-[#6B5E55]">
                ...
                >
                  <span>Abrir no Google Maps App</span>
